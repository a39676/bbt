...
<div class="row" name="baseInfo">
  ...
  <div class="col-md-5 border-bottom border-dark rounded" style="background: linear-gradient(to bottom left, #ffffff , #e6e6e6);">
    ...
    <span class="badge badge-light badge-pill">熟练gradle maven 项目搭建</span><br>
...
<div class="row" name="jobHistory">
  <div class="container-fluid">
    <div class="row border-bottom border-info rounded" style="background: linear-gradient(to bottom right, #ffffff , #fdffd2);">
      <div class="col-md-12">
        <br>
        <br>
        <span class="badge badge-light">2018/01 ~ 2018/08</span> <span class="badge badge-success">公司名0</span><br>
        <span class="badge badge-secondary">互联网金融项目. </span><br>
        <br>
        <span class="badge badge-light">对接多个支付接口</span><br>
        <span class="badge badge-light">与前端同事对接</span><br>
        <span class="badge badge-light">为部分app上线app store提供帮助</span><br>
        <span class="badge badge-primary">对接催收项目</span><br>
        &nbsp;&nbsp;&nbsp;&nbsp;<span class="badge badge-light">定时整理逾期案件，推送至催收系统</span><br>
        &nbsp;&nbsp;&nbsp;&nbsp;<span class="badge badge-light">案件整理分派</span><br>
      </div>
    </div>
    <div class="row border-bottom border-info rounded" style="background: linear-gradient(to bottom left, #ffffff , #fdffd2);">
      <div class="col-md-12">
        <br>
        <br>
        <span class="badge badge-light">2015/11 ~ 2017/12</span> <span class="badge badge-success">公司名1</span><br>
...
<div class="row" style="background: linear-gradient(to bottom left, #ffffff , #8fb7fc);" name="introduction">
  <div class="col-md-12">
    <br>
    <br>
    <span class="badge badge-light">非常高兴您光临这个比较简陋的网站..., 其实我一直主力写后端, 页面方面没有太大投入<img src="http://ww3.sinaimg.cn/large/7280659bgw1f981mdn1klj20c80c8t9f.jpg" style="width: 85px; height: 85px;">, 让您见笑了.</span><br> 
    <span class="badge badge-light"></span><br>
    <span class="badge badge-light">这里再补充一下我个人的情况吧.</span><br>
    <span class="badge badge-light"></span><br>
    <span class="badge badge-light">2009年大专(金融专业)毕业后, 从事金融行业工作(业务线, 非技术类型, 熟悉证券、基金、银行间多种个人, 机构业务)</span><br>
    ...
    <span class="badge badge-light">毕竟对于金融行业的业务逻辑, 无论哪方面, 都是驾轻就熟, 而事实也证明当时选择没错</span><br>
    <span class="badge badge-light">在<span class="badge badge-success">公司名1</span>, 可以全心钻研学习必要的技术, 经历了各种大小版本更新, 甚至项目框架转换. 获益良多</span><br>
    <span class="badge badge-light">可惜行业环境瞬息万变, 政策对互联网金融是越发收紧, 行业对公司的要求(尤其是合规)是越来越高, </span><br>
    <span class="badge badge-light">而自己手上也有一定的技术基础, 故而想寻找一个新的机会, 因此进入了<span class="badge badge-success">公司名0</span></span><br>
    <span class="badge badge-light">但没想到, <span class="badge badge-success">公司名0</span>其实也是以互联网金融业务为主, 但公司氛围, 技术氛围还好, </span><br>
    <span class="badge badge-light">所以做了几个月, 但是几乎半年以来, 一直<u>没有一个合规的渠道</u>...... 这就与当初的愿景违背了</span><br>
    <span class="badge badge-light">于是又开始了寻找新的机会.</span><br>
    <br><br>
    ...
    <span class="badge badge-light">欢迎指出不足之处, 或者其他更好的建议</span><br>
