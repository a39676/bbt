...
public interface CryptoCoinPrice1dayMapper {
    ...
    int updateByExampleSelective(@Param("row") CryptoCoinPrice1day row, @Param("example") CryptoCoinPrice1dayExample example);
    ...
    CryptoCoinPrice1day selectLastDataByCoinTypeAndCurrencyType(@Param("example") CryptoCoinPrice1dayExample example);
}